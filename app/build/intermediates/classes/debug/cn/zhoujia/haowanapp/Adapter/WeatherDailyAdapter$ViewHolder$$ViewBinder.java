...
public class WeatherDailyAdapter$ViewHolder$$ViewBinder<T extends cn.zhoujia.haowanapp.Adapter.WeatherDailyAdapter.ViewHolder> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131558620, "field 'txtDailyForecastDate'");
    target.txtDailyForecastDate = finder.castView(view, 2131558620, "field 'txtDailyForecastDate'");
    view = finder.findRequiredView(source, 2131558621, "field 'txtHourlyForecastTxtD'");
    target.txtHourlyForecastTxtD = finder.castView(view, 2131558621, "field 'txtHourlyForecastTxtD'");
