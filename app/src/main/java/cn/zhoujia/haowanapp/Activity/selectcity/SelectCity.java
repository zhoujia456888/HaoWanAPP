 ...
 */
public class SelectCity extends BaseActivity implements AbsListView.OnScrollListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mIntent.putExtra("cityname", "");
                // 设置结果，并进行传送
                SelectCity.this.setResult(resultCode, mIntent);
                SelectCity.this.finish();

            }
        });
        //变色状态栏
        BaseActivity.ColourStatusBar(SelectCity.this);
        ...
        personList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                if (position >= 2) {
                    ...
                    Intent mIntent = new Intent();
                    mIntent.putExtra("cityname", allCity_lists.get(position).getName());
                    // 设置结果，并进行传送
                    SelectCity.this.setResult(resultCode, mIntent);
                    SelectCity.this.finish();
                }
        ...
        resultList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Toast.makeText(getApplicationContext(),
                        ...
                        .show();
                Intent mIntent = new Intent();
                mIntent.putExtra("cityname", city_result.get(position).getName());
                // 设置结果，并进行传送
                SelectCity.this.setResult(resultCode, mIntent);
                SelectCity.this.finish();
            }
                ...
                hotCity.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view,
                        ...
                        Toast.makeText(getApplicationContext(),
                                ...
                                Toast.LENGTH_SHORT).show();
                        Intent mIntent = new Intent();
                        mIntent.putExtra("cityname", city_hot.get(position).getName());
                        // 设置结果，并进行传送
                        SelectCity.this.setResult(resultCode, mIntent);
                        SelectCity.this.finish();
